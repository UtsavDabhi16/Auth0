...
public class AuthController {
    ...
    private static final String AUTH0_TOKEN_URL = "https://dev-nqh3qhte.us.auth0.com/oauth/token";

    @GetMapping(value = "/login")
    protected void login(HttpServletRequest request, HttpServletResponse response) throws IOException {
        System.out.println("URI is :"+config.getContextPath(request));
...
//        response.sendRedirect(config.getContextPath(request) + "/");
    ...
    public String getManagementApiToken() {
        ...
        requestBody.put("audience", "https://dev-nqh3qhte.us.auth0.com/api/v2/");
